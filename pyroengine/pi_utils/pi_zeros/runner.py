...
class Runner:
    ...
    def capture_stream(self):
        ...
        time.sleep(self.CAPTURE_DELAY_S)  # small sleep here improve image quality
...
if __name__ == "__main__":
    ...
    parser.add_argument('--loop_interval', default=30, action='store_true', help='Time in seconds between two photos')
    ...
    runner = Runner(webserver_local_url, loop_interval_s=args.loop_interval, max_iteration=args.max_iteration)
    if args.single:
